...
@Getter
public class ActivateGroupGatewayItemsDialog extends BaseDialog<SuperAcquirersPage, ActivateGroupGatewayItemsDialog> {

    private final Locator confirmationQuestion = getDialog().locator("p");

    public ActivateGroupGatewayItemsDialog(Page page) {
        super(page);
    }
